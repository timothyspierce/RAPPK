...
map_with_all_point <- leaflet() %>%
  ...
  addPolygons(data = pop_centroid_RPK_iso_60 , color = "white",
              opacity = 1, weight = 1, fillColor = "white",fillOpacity = .2)%>%
  addLegend(colors = "white", labels = "60 Minute Drive") %>%
  addPolygons(data = pop_centroid_RPK_iso_30 , color = "green",
              opacity = 1, weight = 1, fillColor = "green",fillOpacity = .2)%>%
  addLegend(colors = "green", labels = "30 Minute Drive") %>%
